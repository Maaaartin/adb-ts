...
export default class AdbDevice implements IAdbDevice {
    ...
    openTcp(port: number | string, host?: any, cb?: (err: Error, value: Connection) => void) {
    ...
    install(apk: string | Readable, options?: any, args?: any, cb?: (err: Error) => void) {
    ...
    startActivity(pkg: string, activity: string, options?: any, cb?: (err: Error) => void) {
    ...
    startService(pkg: string, service: string, options?: any, cb?: (err: Error) => void) {
    ...
    push(srcPath: string | Readable, destPath: string, mode?: any, cb?: (err: Error, value: PushTransfer) => void) {
    ...
    listSettings(mode: SettingsMode, cb?: (err: Error, value: KeyStringObject[]) => void) {
    ...
    getSetting(mode: SettingsMode, name: string, cb?: (err: Error, value: SimpleType) => void) {
        return this.client.getSetting(this.id, mode, name, cb);
    }

    putSetting(mode: SettingsMode, name: string, value: SimpleType, cb?: (err: Error) => void) {
    ...
    keyEvent(code: KeyCode | number, options?: InputOptions & { longpress?: boolean }, cb?: (err: Error) => void): Promise<void>;
    ...
    swipe(x1: number, y1: number, x2: number, y2: number, options?: InputOptions & { duration?: number }, cb?: (err: Error) => void): Promise<void>;
    swipe(x1: number, y1: number, x2: number, y2: number, options?: any, cb?: (err: Error) => void) {
    ...
    dragAndDrop(x1: number, y1: number, x2: number, y2: number, options?: InputOptions & { duration?: number }, cb?: (err: Error) => void): Promise<void>;
    dragAndDrop(x1: number, y1: number, x2: number, y2: number, options?: any, cb?: (err: Error) => void) {
    ...
    custom<T>(CustomCommand: CommandConstruct, cb?: (err: Error, value: T) => void) {
